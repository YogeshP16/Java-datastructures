...
public class OO1_STRING {
    ...
    public static void main(String[] args) {
        ...
        String s2 = new String("Hello"); // new keyword --> stored in Heap (NON_POOL)
        ...
        // equals operator
        System.out.println(str1 == str2); // it return TRUE both reference are pointing to same memory location

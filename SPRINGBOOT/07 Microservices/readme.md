...
- [Two Ways to Use Saga](#two-ways-to-use-saga)
  - [Choreography (Event-Driven)](#choreography-event-driven)
  - [Orchestration (Central Controller)](#orchestration-central-controller)
- [Choreography vs. Orchestration – When to Use?](#choreography-vs-orchestration-when-to-use)
...
- [Circuit Breaker (Resilience4j / Hystrix)](#circuit-breaker-resilience4j-hystrix)
- [Service Discovery & Load Balancing (Eureka / Consul)](#service-discovery-load-balancing-eureka-consul)
- [Message Queue (Asynchronous Communication - Kafka/RabbitMQ)](#message-queue-asynchronous-communication-kafka-rabbitmq)

...
- [Java Class & Object](#java-class--object)
    - [What is a Class?](#what-is-a-class)
    - [What is an Object?](#what-is-an-object)
    - [Class vs Object](#class-vs-object)
    - [Properties of an Object](#properties-of-an-object)
    - [Accessing Instance Variables](#accessing-instance-variables)
    - [Dynamic Memory Allocation](#dynamic-memory-allocation)
    - [Manipulating Objects](#manipulating-objects)
- [Java Constructor](#java-constructor)
    - [What is a Constructor?](#what-is-a-constructor)
    - [Constructor Overloading](#constructor-overloading)
    - [Calling a Constructor from Another Constructor](#calling-a-constructor-from-another-constructor)
    - [Why Default Constructor](#why-default-constructor)
    - [Why Not Use `new` Keyword for Primitives?](#why-not-use-new-keyword-for-primitives)
    - [Memory Allocation of `new` Keyword](#memory-allocation-of-new-keyword)
- [Wrapper Classes, `final` Keyword, Garbage Collection, and `finalize` Keyword in Java](#wrapper-classes-final-keyword-garbage-collection-and-finalize-keyword-in-java)
    ...
    - [`finalize` Keyword in Java](#finalize-keyword-in-java)
- [Java Packages](#java-packages)
    - [Definition](#definition)
    - [Key Points](#key-points)
    - [How It Works](#how-it-works)
    - [In-built Java Packages](#in-built-java-packages)
- [Static in Java](#static-in-java)
    - [What is it?](#what-is-it)
    - [Static Variables](#static-variables)
    - [Instance vs static](#instance-vs-static)
    - [Static Methods](#static-methods)
    - [Static Block](#static-block)
    - [Why `psvm` is Static?](#why-psvm-is-static)
    - [Non-static Member in Static Method](#non-static-member-in-static-method)
    - [Static Member in Non-static Method](#static-member-in-non-static-method)
    - [`this` Inside Static Methods](#this-inside-static-methods)
...
- [Inheritance in Java](#inheritance-in-java)
    ...
    - [How It Works?](#how-it-works)
    - [Keywords in Inheritance](#keywords-in-inheritance)
    - [Types of Inheritance](#types-of-inheritance)
    - [Can We Access Child Class Data from the Base Class?](#can-we-access-child-class-data-from-the-base-class)
...
- [Encapsulation vs Abstraction Flashcard](#encapsulation-vs-abstraction-flashcard)
    - [Encapsulation](#encapsulation)
    - [Abstraction](#abstraction)
    - [Key Differences](#key-differences)
    - [Example](#example)
    - [Data Hiding](#data-hiding)
    - [Data Hiding vs Encapsulation](#data-hiding-vs-encapsulation)
- [Access Control in Java](#access-control-in-java)
    - [What it is](#what-it-is)
    - [Why it's used](#why-its-used)
    - [Access Modifiers & Visibility](#access-modifiers--visibility)
    - [Key Example](#key-example)
    - [Key Points](#key-points)
    - [Simplified Rule](#simplified-rule)
- [Abstract Classes in Java](#abstract-classes-in-java)
    - [What is an Abstract Class?](#what-is-an-abstract-class)
    - [Multiple Inheritance Issue](#multiple-inheritance-issue)
    - [Abstract Class Rules](#abstract-class-rules)
    - [Example](#example-1)
    - [Constructor in Abstract Classes](#constructor-in-abstract-classes)
    - [Object Creation](#object-creation)
    - [Abstract Static Methods](#abstract-static-methods)
    - [Static Methods in Abstract Classes](#static-methods-in-abstract-classes)
...
- [Custom ArrayList with Generics](#custom-arraylist-with-generics)
    - [What it is](#what-it-is)
    - [Key Points](#key-points)
    - [Wildcards in Generics](#wildcards-in-generics)
- [Comparison Objects & Cloning in Java](#comparison-objects--cloning-in-java)
    - [Comparison Objects](#comparison-objects)
    - [`compareTo` Methods](#compareto-methods)
...
- [Exception Handling in Java](#exception-handling-in-java)
    ...
    - [Common Unchecked Exceptions](#common-unchecked-exceptions)
- [JVM Memory Types](#jvm-memory-types)
    - [Stack Memory in Java](#stack-memory-in-java)
    - [Heap Memory in Java](#heap-memory-in-java)
    - [Garbage Collection in Detail](#garbage-collection-in-detail)
